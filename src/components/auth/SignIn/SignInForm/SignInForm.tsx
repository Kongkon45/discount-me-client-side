...
const SignInForm = () => {
  ...
  return (
    <div className="bg-gray-300 pt-[20px] pb-[30px] md:pb-[50px] lg:pb-[100px]">
      ...
      <form className="px-[30px] md:px-0 w-full md:w-1/2 lg:w-1/3 mx-auto" onSubmit={handleSubmit(onSubmit)}>
        <div>
        ...
        <div className="flex justify-between items-center py-[20px]">
            ...
            <input className="w-[22px] h-[22px] md:w-[26px] md:h-[26px]" type="checkbox" name="check" />
