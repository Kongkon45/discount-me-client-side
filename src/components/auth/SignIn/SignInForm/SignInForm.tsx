...
const SignInForm = () => {
  ...
  return (
    <div className="bg-gray-300 pt-[20px] pb-[100px]">
        <h4 className="text-[48px] text-center text-dark-400 font-semibold pb-[20px]">Sign In</h4>
      <form className="w-full md:w-1/2 lg:w-1/3 mx-auto" onSubmit={handleSubmit(onSubmit)}>
        <div>
