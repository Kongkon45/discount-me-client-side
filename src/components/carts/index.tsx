    ...
    <div className="px-5 md:px-16 lg:px-20 xl:px-28 2xl:px-32 3xl:px-40 4xl:px-44 5xl:px-[200px]">
      ...
      <div className="lg:flex w-full gap-40 mt-10 lg:pb-[120px] pb-[60px] ">
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="hover:bg-primary hover:text-white border-2 border-primary rounded-full text-primary py-1 px-1 transition-all ease-in-out duration-700"
                    >
                      <RiDeleteBin6Fill />
                    </button>
                  </li>
        ...
        <div className="lg:w-4/12 w-full border rounded-lg shadow-lg p-4 my-3 profile__bg">
          ...
          <button
            className="w-full my-6 bg-primary text-white py-2 px-4 rounded-lg hover:border-2 hover:bg-white hover:text-primary hover:border-primary transition-all duration-200 ease-in-out text-base"
            type="submit"
          >
